...
const CVJobProgress: React.FC<CVJobProgressProps> = ({ onComplete, onError }) => {
  ...
  if (!job) {
    return (
      <div className="p-4 bg-slate-900/60 rounded-xl border border-slate-800 text-slate-500 text-sm">
      ...
      <div className="p-4 bg-blue-900/30 border border-blue-700 rounded-xl">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-blue-400 text-sm">Waiting to start...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="p-4 bg-slate-900/60 rounded-xl border border-slate-800">
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <p className="text-sm font-medium text-slate-200">{job.stage}</p>
          ...
          <div className="flex items-center space-x-2">
            <div className="animate-pulse h-2 w-2 bg-sky-500 rounded-full"></div>
            <p className="text-xs text-slate-400">Generating your CV...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="space-y-3">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-emerald-400 text-sm mt-1">{job.stage}</p>
            </div>
          </div>
        ...
        <div className="space-y-3">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-red-400 text-sm mt-1">{job.stage}</p>
            </div>
          </div>
          ...
          {job.error_message && (
            <details className="mt-2">
              ...
              <pre className="mt-2 p-3 bg-slate-950 rounded border border-slate-700 text-xs text-red-400 overflow-x-auto max-h-40">
                {job.error_message}
              </pre>
            </details>
          )}
