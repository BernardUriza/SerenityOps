...
const ProfileForm: React.FC<ProfileFormProps> = ({ personal, summary, onChange }) => {
  return (
    <div className="bg-slate-800 border border-slate-700 rounded-lg shadow-sm p-8">
      <h2 className="text-2xl font-bold text-slate-50 mb-6">Personal Information</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 bg-slate-900 border border-slate-700 text-slate-50 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
        </div>
